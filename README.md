...
I’m a hands-on engineering leader with a background across **full-stack development, AI systems, Salesforce architecture, cloud infrastructure, workflow automation, and enterprise integrations**.

My work is usually focused on one goal: **make the business run faster with better software**.
...
![TanStack](https://img.shields.io/badge/TanStack-ECE8D1?style=flat-square&logo=tanstack&logoColor=black)
...
### AI, automation & data
![Codex](https://img.shields.io/badge/Codex-B1A7FF?style=flat-square&logo=openaigym&logoColor=black)
...
I like teams that are practical, curious, and fast-moving. My core philosophy is to ensure everyone _feels_ powerful.
